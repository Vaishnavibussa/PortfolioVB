...
//         <img src="/icons/hackathon.svg" alt="Hackathon Icon" className="icon" />
...
//             connecting farmers directly with consumers, leveraging AI/ML for crop predictions and blockchain for transactions.
//           </p>
//         </div>
//       </div>

//       <div className="achievement-box">
//         <img src="/icons/certificate.svg" alt="Certificate Icon" className="icon" />
//         <div className="content">
//           <h2>Certificates</h2>
//           <ul>
...
//       <div className="achievement-box">
//         <img src="/icons/book.svg" alt="Book Icon" className="icon" />
//         <div className="content">
//           <h2>DSA Book</h2>
//           <p>
//             Authored a comprehensive Data Structures and Algorithms book for college students, covering linked lists,
//             trees, sorting, and problem-solving techniques with examples and exercises.
//           </p>
//         </div>
//       </div>

//       <div className="achievement-box leadership">
//         <img src="/icons/leader.svg" alt="Leadership Icon" className="icon" />
//         <div className="content">
...
//             As a <strong>Senior Mentor at AAC</strong>, I’ve guided <strong>40+ juniors</strong> across multidisciplinary domains —
//             from <em>web development</em> and <em>AI/ML</em> to <em>computer science fundamentals</em> — nurturing their growth through structured mentorship and hands-on collaboration.
//           </p>
//         </div>
//       </div>

//       <div className="achievement-box">
//         <img src="/icons/contributor.svg" alt="Contributor Icon" className="icon" />
//         <div className="content">
//           <h2>Open Source & Contributions</h2>
//           <p>
//             Actively contribute to open-source projects with a focus on educational tools and developer communities.
//             Recognized contributor at GSSoC and other initiatives.
//           </p>
//         </div>
//       </div>
//     </section>
