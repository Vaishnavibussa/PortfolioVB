...
//   return (
//     <div className="parallax" ref={ref} style={{background:type==="services"?"Linear-gradient(180deg, #111132, #0c0c1d)":"Linear-gradient(180deg, #111132, #505064)"}}>Parallax
...
//   const yText = useTransform(scrollYProgress, [0, 1], ["0%", "500%"]);
//   const yBg = useTransform(scrollYProgress, [0, 1], ["0%", "100%"]);
//   const xBg = useTransform(scrollYProgress, [0, 1], ["0%", "100%"]); // Only if horizontal needed
